                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                    ...
                    <div className="space-y-6">
                        ...
                        <p className="text-cream/50 leading-relaxed">
                            Crafting memories one slice at a time. Our homemade cakes are made with passion,
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-cream/60">
                            ...
                            <li><Link href="#collection" className="hover:text-gold transition-colors">Featured Cakes</Link></li>
                            ...
                            <li><Link href="#order" className="hover:text-gold transition-colors">Custom Order</Link></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-cream/60">
                            <li><Link href="#" className="hover:text-gold transition-colors">Wedding Cakes</Link></li>
                            <li><Link href="#" className="hover:text-gold transition-colors">Birthday Cakes</Link></li>
                            <li><Link href="#" className="hover:text-gold transition-colors">Cupcakes</Link></li>
                            <li><Link href="#" className="hover:text-gold transition-colors">Pastries</Link></li>
                            <li><Link href="#" className="hover:text-gold transition-colors">Gift Hampers</Link></li>
                        </ul>
                    </div>
