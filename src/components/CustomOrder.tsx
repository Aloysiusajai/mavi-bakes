...
const flavors = [
    { id: "chocolate", name: "Chocolate Ganache", color: "bg-chocolate", image: "/images/chocolate_cake.png" },
    { id: "velvet", name: "Red Velvet", color: "bg-red-600", image: "/images/red_velvet_cake.png" },
    { id: "vanilla", name: "Classic Vanilla", color: "bg-cream", image: "/images/hero_cake.png" },
    { id: "berry", name: "Strawberry Blush", color: "bg-blush", image: "/images/red_velvet_cake.png" },
];

const sizes = ["Small (6\")", "Medium (8\")", "Large (10\")", "Multi-tier (Custom)"];
                            ...
                            <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
                                    ...
                                    {[1, 2, 3].map(step => (
                                        <div key={step} className="flex items-center gap-2">
                                            <div className={cn(
                                                ...
                                                currentStep === step ? "bg-gold text-cream" : step < currentStep ? "bg-chocolate text-cream" : "bg-cream text-chocolate"
                                            )}>
                                                {step}
                                            </div>
                                ...
                                <AnimatePresence mode="wait">
                                    {currentStep === 1 && (
                                        ...
                                        >
                                            <h3 className="text-xl font-bold flex items-center gap-2">
                                                <Palette size={20} className="text-gold" /> Choose Your Flavor
                                            </h3>
                                                ...
                                                {flavors.map(f => (
                                                    <div
                                                        ...
                                                        className={cn(
                                                            ...
                                                            selectedFlavor.id === f.id ? "border-gold bg-gold/5 shadow-md" : "border-cream hover:border-gold/30"
                                                        )}
                                                    >
                                                        <div className={cn("w-6 h-6 rounded-full border border-chocolate/10", f.color)} />
                                                        <span className="font-medium text-chocolate">{f.name}</span>
                                                    </div>
                                                ))}
                                            </div>
                                            ...
                                            <div className="space-y-4">
                                                ...
                                                <select {...register("size")} className="w-full p-4 rounded-2xl border-2 border-cream focus:border-gold outline-none bg-cream/30">
                                    ...
                                    {currentStep === 2 && (
                                        ...
                                        >
                                            <h3 className="text-xl font-bold flex items-center gap-2">
                                                <Sparkles size={20} className="text-gold" /> Personalization
                                            </h3>
                                            <div className="space-y-4">
                                                <label className="block font-medium text-chocolate">Special Message on Cake</label>
                                                <input
                                                    {...register("message")}
                                            ...
                                            <div className="space-y-4">
                                                <label className="block font-medium text-chocolate">Upload Inspiration (Optional)</label>
                                                <label className="w-full p-8 rounded-2xl border-2 border-dashed border-gold/30 flex flex-col items-center justify-center cursor-pointer hover:bg-gold/5 transition-all">
                                                    ...
                                                    <span className="text-sm text-chocolate/50">Click to upload or drag & drop</span>
                                    ...
                                    {currentStep === 3 && (
                                        ...
                                        >
                                            <h3 className="text-xl font-bold flex items-center gap-2">
                                                <Send size={20} className="text-gold" /> Delivery Details
                                            </h3>
                                            <div className="space-y-4">
                                                <label className="block font-medium text-chocolate">Event Date</label>
                                                <input
                                                    type="date"
                                                    {...register("date")}
                                                    className="w-full p-4 rounded-2xl border-2 border-cream focus:border-gold outline-none bg-cream/30"
                                            ...
                                            <div className="space-y-4">
                                                <label className="block font-medium text-chocolate">Your Name</label>
                                                <input
                                                    {...register("name")}
                                            ...
                                            <div className="space-y-4">
                                                <label className="block font-medium text-chocolate">Phone Number</label>
                                                <input
                                                    {...register("contact")}
                    ...
                    <div className="hidden lg:block w-96">
                        <div className="sticky top-32">
                            ...
                            <div className="mt-8 text-center">
                                <p className="text-chocolate/40 text-sm italic font-medium">✨ Visual rendering in progress based on your choices</p>
                            </div>
                        </div>
                    </div>
