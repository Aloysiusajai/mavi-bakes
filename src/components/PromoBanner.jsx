  ...
  return (
    <>
      <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-[150]">
        ...
        >
          <div className="w-10 h-10 rounded-full bg-cream flex items-center justify-center font-bold text-chocolate">
            M
          </div>
          <div>
            <p className="text-sm font-bold text-chocolate">
              Special Offer — 20% off custom cakes
            </p>
            <p className="text-xs text-chocolate/70">
              Limited slots • Tap to claim
            </p>
          </div>
          <div className="ml-4">
            <button
