  ...
  return (
    ...
    >
      <div className="w-10 h-10 rounded-full bg-white/20 flex items-center justify-center">
        ...
        >
          <path
            d="M20.52 3.48C18.18 1.14 15.02 0 11.66 0 5.22 0 .1 5.12.1 11.56c0 2.04.54 3.98 1.56 5.7L0 24l6.9-1.8c1.62.9 3.44 1.36 5.36 1.36 6.44 0 11.56-5.12 11.56-11.56 0-3.36-1.14-6.52-3.3-8.72z"
            fill="currentColor"
          />
        </svg>
      </div>
