...
const testimonials = [
  {
    ...
    role: "Bride",
    content:
      "The wedding cake was beyond my expectations! Not only was it stunningly beautiful, but every layer was incredibly moist and flavorful. Our guests couldn't stop talking about it.",
  ...
  },
  {
    ...
    role: "Birthday Boy",
    content:
      "Ordered a custom chocolate cake for my graduation. The ganache was so rich and the presentation was top-tier. Best homemade cake in the city, hands down!",
  ...
  },
  {
    ...
    role: "Party Planner",
    content:
      "I've worked with many bakeries, but the attention to detail here is unmatched. The cupcakes were consistent, elegant, and absolutely delicious. Highly recommend!",
